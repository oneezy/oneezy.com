...
<svelte:head>
  <title>About Justin O'Neill | Oneezy</title>
  ...
  <meta property="og:title" content="About Justin O'Neill | Oneezy" />
  ...
  <meta property="og:image" content="{$page.url.origin}/about/og.png" />
</svelte:head>
